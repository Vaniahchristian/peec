...
export const Contact = () => {
  ...
  return (
    <>
      <Helmet>
        <meta name="description" content="Get in touch with PEEC Systems. Contact us for more information." />
        <title>Contact Us - PEEC Systems</title>
      </Helmet>
                ...
                <div className="bg-green-50 dark:bg-gray-800 p-6 rounded-lg shadow-md">
                  ...
                  <div className="space-y-4">
                    <p className="flex items-center text-gray-600 dark:text-gray-300">
                      <svg className="w-5 h-5 mr-3 text-green-600 dark:text-green-400" role="img" aria-label="Phone Icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                      </svg>
                      +256 757 017 760 / +256 788 420 335
                    </p>
                    <p className="flex items-center text-gray-600 dark:text-gray-300">
                      <svg className="w-5 h-5 mr-3 text-green-600 dark:text-green-400" role="img" aria-label="Email Icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                      </svg>
                      peecsystemsltd@gmail.com
                    </p>
                    <p className="flex items-center text-gray-600 dark:text-gray-300">
                      <svg className="w-5 h-5 mr-3 text-green-600 dark:text-green-400" role="img" aria-label="Location Icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
